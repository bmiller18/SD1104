...
namespace lab3_4RegExConsoleApp
{
    public class Example
    {
        public static void Main()
        {
            ...
            string input = @"Episode IV, A NEW HOPE It is a period of civil war. Rebel spaceships, striking from a hidden base, 
                        ...
                        an armored space station with enough power to destroy an entire planet. Pursued by the Empire’s sinister agents, 
